...
//
     ...
     *
     * @param   list         the new data vector
     * @param   columnNames     the names of the columns
     * @see #getDataVector
     */
    public void setDataVector(List<List<Object>> list, List<Object> columnNames) {
        this.dataVector = nonNullVector(list);
        this.columnIdentifiers = nonNullVector(columnNames);
    ...
    public void setDataVector(Object[][] dataVector, Object[] columnIdentifiers) {
        setDataVector(convertToVector(dataVector), convertToList(columnIdentifiers));
    }
...
//
    ...
    protected static List convertToList(Object[] anArray) {
        ...
        List<Object> v = new ArrayList<Object>(anArray.length);
    ...
    protected static List convertToVector(Object[][] anArray) {
        ...
        List<List> v = new ArrayList<List>(anArray.length);
        for (Object[] o : anArray) {
