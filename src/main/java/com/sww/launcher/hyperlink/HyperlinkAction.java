...
public class HyperlinkAction extends AbstractHyperlinkAction<URI> {
	...
	private static final long serialVersionUID = -4459494445581752344L;
	private static final Logger LOG = LogManager.getLogger(HyperlinkAction.class.getName());
